    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recipe_ingredients', to='mainapp.ingredient')),
        ...
        migrations.AddField(
            model_name='recipe',
            name='ingredients',
            field=models.ManyToManyField(related_name='recipes', through='mainapp.RecipeIngredient', to='mainapp.Ingredient'),
        ),
        migrations.CreateModel(
            name='Purchase',
            fields=[
